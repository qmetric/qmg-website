...
function createDiv(){
    ...
    div.innerHTML = "<div class='container'><h5><strong>Alert</strong><span class='cookie-message-close close-cookie-banner' onclick='removeMe();'>Close<span class='icon icon-cancel'><img src=\"img/cross_large.png\" style='width:15px;height:auto' alt=\"cross\"></span></span></h5><p>If you have received a Policy Expert \"purchase confirmation\" email, but have not bought a policy from us, please delete it immediately and do not click on any of the links. This is a phishing attempt by a third party. </p><p>Policy Expert data remains secure and has not been compromised.</p> <p>We apologise for any inconvenience and can confirm that we are taking action to try and stop any re-occurrence. <a href='/alert-phishing-scam'>Read more.</a></p></div>";
